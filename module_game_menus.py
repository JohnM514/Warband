...
#          (try_end),
  ...
  ("bank",
         ...
         [
		  ...
		  (assign,reg7,"$player_debt"),
		 ],
		 [
		  ("pay_loan",[(store_troop_gold,":player_wealth","trp_player"),(store_sub,":player_real_wealth",":player_wealth","$player_debt"),(ge,":player_real_wealth",1000)],"Pay 1000 denars of your debt to the bank.",
		   [
		    (troop_remove_gold,"trp_player",1000),
			(val_sub,"$player_debt",1000),
		   ]),
		  ("pay_loan",[(store_troop_gold,":player_wealth","trp_player"),(store_sub,":player_real_wealth","player_wealth","$player_debt"),(ge,"player_real_wealth","$player_debt")],"Pay all your debt to the bank.",
		   [
		    (troop_remove_gold,"trp_player","$player_debt"),
			(val_sub,"$player_debt","$player_debt"),
		   ]),
		  ("take_loan",(ge,"$player_deposit",100),"Take a loan of 1000 denars.",
		   [
			(troop_add_gold,"trp_player",1000),
			(val_add,"$player_debt",1000),
		   ]),
		  ("take_loan",(ge,"$player_deposit",500),"Take a loan of 5000 denars.",
		   [
			(troop_add_gold,"trp_player",5000),
			(val_add,"$player_debt",5000),
		   ]),
		  ("deposit",[(store_troop_gold,":player_wealth","trp_player"),(store_sub,":player_real_wealth",":player_wealth","$player_debt"),(ge,":player_real_wealth",100)],"Deposit 100 denars in the bank.",
		   [
		    (troop_remove_gold,"trp_player",100),
			(val_add,"$player_deposit",100),
		   ]),
		  ("deposit",[(store_troop_gold,":player_wealth","trp_player"),(store_sub,":player_real_wealth",":player_wealth","$player_debt"),(ge,":player_real_wealth",1000)],"Deposit 1000 denars in the bank.",
		   [
		    (troop_remove_gold,"trp_player",1000),
			(val_add,"$player_deposit",1000),
		   ]),
		  ("deposit",[(store_troop_gold,":player_wealth","trp_player"),(store_sub,":player_real_wealth",":player_wealth","$player_debt"),(ge,":player_real_wealth",5000)],"Deposit 5000 denars in the bank.",
		   [
		    (troop_remove_gold,"trp_player",5000),
			(val_add,"$player_deposit",5000),
		   ]),
		  ("take_deposit",(ge,"$player_deposit",1000),"Withdraw 1000 denars from your deposit.",
		   [
		    (val_sub,"$player_deposit",1000),
			(troop_add_gold,"trp_player",1000),
		   ]),
		  ("take_deposit",(ge,"$player_deposit","$player_deposit"),"Withdraw your entire deposit from the bank.",
		   [
			(troop_add_gold,"trp_player","$player_deposit"),
			(val_sub,"$player_deposit","$player_deposit"),
		   ]),
		  ("back_to_town_menu",[],"Head back.",
           [
           (jump_to_menu,"mnu_town"),
