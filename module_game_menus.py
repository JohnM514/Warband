...
#          (try_end),
  ...
  ("bank",0,
   ...
   [
    ("pay_loan_1000",[(gt,"$g_player_debt",0),(store_troop_gold,":player_wealth","trp_player"),(store_sub,":player_real_wealth",":player_wealth","$g_player_debt"),(ge,":player_real_wealth",1000)],
	 "Pay 1000 denars of your debt to the bank",[
	                                             (troop_remove_gold,"trp_player",1000),
												 (val_sub,"$g_player_debt",1000),
												]),
	("pay_loan_all",[(gt,"$g_player_debt",0),(store_troop_gold,":player_wealth","trp_player"),(store_sub,":player_real_wealth",":player_wealth","$g_player_debt"),(ge,":player_real_wealth","$g_player_debt")],	
     "Pay all your debt to the bank",[
	                                  (troop_remove_gold,"trp_player","$g_player_debt"),
									  (val_sub,"$g_player_debt",reg7),
									 ]),
	("take_loan_1000",[(ge,"$g_player_deposit",100)],
	 "Take a loan of 1000 denars.",[
			                        (troop_add_gold,"trp_player",1000),
			                        (val_add,"$g_player_debt",1000),
		                           ]),
    ("take_loan_5000",[(ge,"$g_player_deposit",500)],
	 "Take a loan of 5000 denars.",[
			                        (troop_add_gold,"trp_player",5000),
			                        (val_add,"$g_player_debt",5000),
		                           ]),
    ("deposit_100",[(store_troop_gold,":player_wealth","trp_player"),(store_sub,":player_real_wealth",":player_wealth","$g_player_debt"),(ge,":player_real_wealth",100)],
	 "Deposit 100 denars in the bank.",[
		                                (troop_remove_gold,"trp_player",100),
			                            (val_add,"$g_player_deposit",100),
		                               ]),
	("deposit_1000",[(store_troop_gold,":player_wealth","trp_player"),(store_sub,":player_real_wealth",":player_wealth","$g_player_debt"),(ge,":player_real_wealth",1000)],
	 "Deposit 1000 denars in the bank.",[
		                                 (troop_remove_gold,"trp_player",1000),
			                             (val_add,"$g_player_deposit",1000),
		                                ]),
	("deposit_5000",[(store_troop_gold,":player_wealth","trp_player"),(store_sub,":player_real_wealth",":player_wealth","$g_player_debt"),(ge,":player_real_wealth",5000)],
	 "Deposit 5000 denars in the bank.",[
		                                 (troop_remove_gold,"trp_player",5000),
			                             (val_add,"$g_player_deposit",5000),
                                        ]),	
    ("take_deposit_1000",[(ge,"$g_player_deposit",1000)],
	 "Withdraw 1000 denars from your deposit.",[
		                                        (val_sub,"$g_player_deposit",1000),
			                                    (troop_add_gold,"trp_player",1000),
		                                       ]),
	("take_deposit",[(gt,"$g_player_deposit",0)],
	 "Withdraw your entire deposit from the bank.",[
			                                        (troop_add_gold,"trp_player","$g_player_deposit"),
